...
html: `
  ...
  ">
    ...
    <p>
      We are pleased to inform you that your profile has been shortlisted and
      you have been selected for the interview process for the position of
    ...
    <div>
      <p><strong>Position:</strong> ${interview.role}</p>
    ...
    <p style="margin-top:20px;">
      Your resume has been successfully shared with the interview panel for reference.
    </p>

    <p>
      Kindly ensure your availability at the scheduled time.
      We request you to join the meeting 5–10 minutes before the interview begins.
    </p>
...
html: `
  ...
  ">
    ...
    <div >
      <p><strong>Candidate Name:</strong> ${interview.candidateName}</p>
...
html: `
  ...
  ">
    ...
    <div >
      ...
      <p><strong>Interviewer Name:</strong> ${interview.interviewerName}</p>
    ...
    <p style="margin-top:20px;">
      The candidate resume and interview details have been shared successfully with the respective interviewer and candidate.
    </p>

    <p style="margin-top:30px;">
      Thanks & Regards,<br/>
      <strong>Creative Web Solution</strong><br/>
      🌐 www.creativewebsolution.in
    </p>
...
">
  ...
  <div >
    <p><strong>Interview Date:</strong> ${interview.date}</p>
